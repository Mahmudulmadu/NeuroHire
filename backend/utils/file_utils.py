...
file_handler = logging.FileHandler(os.path.join(LOG_DIR, 'ats_resume_scorer.log'))
...
class ATSBaseError(Exception):
    ...
    def __init__(self, message: str, user_message: Optional[str] = None, **kwargs  ):
        ...
        self.user_message = user_message or "An error occurred while processing the resume."
